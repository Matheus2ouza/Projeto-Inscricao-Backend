...
import { EnvironmentVariableNotFoundException } from 'src/usecases/web/exceptions/environment-variable-not-found.usecase.exception';

@Catch(EnvironmentVariableNotFoundException)
export class EnvironmentVariableNotFoundExceptionFilter
...
export const EnvironmentVariableNotFoundExceptionFilterProvider = {
  provide: APP_FILTER,
  useClass: EnvironmentVariableNotFoundExceptionFilter,
};

import { GeneratePdfParticipantsSelectedAccountsOutput } from 'src/usecases/web/participants/reports/pdf/generate-pdf-participant/generate-pdf-participants-selected-accounts.usecase';

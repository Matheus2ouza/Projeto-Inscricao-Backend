import { GeneratePdfDetailsGuestInscriptionOutput } from 'src/usecases/web/inscription/pdf/generate-pdf-details-guest-inscription/generate-pdf-details-guest-inscription.usecase';
